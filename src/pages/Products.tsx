...
const products: CMKProduct[] = [
  ...
  {
    name: 'CMK Diamond',
    desc: 'Our high-performance cattle feed engineered for high-yield dairy cows and buffaloes. Formulated with top-grade ingredients to improve milk quality, enhance fat% and SNF, and ensure optimal rumen health. A complete nutritional package that boosts daily milk production and keeps your livestock strong and fertile.',
    protein: '20%',
    energy: '13.2 MJ',
    badge: 'Heavy Yield',
    badgeClass: 'badge--orange',
    features: ['Steamed Pellet', 'High Fat & SNF', 'Rumen Health', 'No Urea'],
    target: 'High-producing cows & buffaloes',
    weight: '50 kg',
    color: '#e65c00',
    image: '/images/cmk-diamond-product.jpg',
  },
]
